...
* Illustrative Example
  * python: creating_and_pickling_data.ipynb is a jupyter notebook where the 15000 nIDPs for the illustrative example are selected. Files with the prefix "creating_imp_mat_" contin code for handling missing data for each method. Files with the prefix "feature_selection_" contin code for selecting the 15 features for each method.
